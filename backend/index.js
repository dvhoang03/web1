...
app.post('/clearcart', fetchUser, async (req, res) => {
    ...
    try {
        ...
        // Success response with clear message
        res.status(200).json({ success: true, message: 'Cart successfully cleared!' });
    } catch (error) {
        console.error('Error clearing cart:', error);
        res.status(500).json({ success: false, error: 'An error occurred while clearing your cart.' });
    }
});
